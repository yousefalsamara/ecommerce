...
@section('content')
    ...
    <div class="card">
        ...
        <div class="form-group">
            ...
            <input id="title" type="text" name="title" placeholder="Enter title"   class="form-control" value="{{$p->title}}">

        </div>

        <div class="form-group">
            <label  class="col-form-label">small Description<span class="text-danger">*</span></label>
            <input id="small_description" type="text" name="small_description" placeholder="small Description"   class="form-control" value="{{$p->small_description}}">

        </div>

            <div class="form-group">
                <label  class="col-form-label">Description<span class="text-danger">*</span></label>
                <textarea id="description" type="text" name="description"  placeholder="Description" class="form-control" >{{$p->description}}</textarea>
            ...
            <div class="col-md-3 form-group">
                ...
                <input id="original_price" type="number" name="original_price" placeholder="Enter original price"   class="form-control" value="{{$p->original_price}}">
            ...
            <div class="col-md-3 form-group">
                ...
                <input id="selling_price" type="number" name="selling_price" placeholder="Enter selling_price" class="form-control" value="{{$p->selling_price}}" >
            ...
            <select class="form-select" aria-label="Default select example" id="cate_id" name="cate_id">
               ...
               @foreach($category as $c)
                    <option value="{{$c->id}}" @if($c->id ==$p->cate_id) selected="selected" @endif>{{$c->title}}</option>
@endforeach
            </select>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 form-group">
                    <input type="number" name="tax" class="form-control" id="tax" placeholder="tax" value="{{$p->tax}}" >

                </div>

                <div class="col-lg-3 form-group">
                    <input type="number"  name="qty" class="form-control " id="qty" placeholder="Quantity" value="{{$p->qty}}" >
            ...
            <div class="row">
                <div class="col-lg-3 form-group">
                    <label >status</label>
                    <input type="checkbox" name="status" {{$p->status == '1'?'checked' :''}}>
                </div>
                <div class="col-lg-3 form-group">
                    <label >trending</label>
                    <input type="checkbox"  {{$p->trending == '1'?'checked' :''}} name="trending">
                </div>
            </div>
        ...
        <div class="col-md-12 mb">
            ...
            <img src="{{asset('/storage/storage/'.$p->image)}}" width="500px" height="500px"alt="Image">
